...
**********************************************************************************************************************************************************
1.python
	Download from http://www.python.org/getit/ and install it. It is better to add the install path to PATH in environment varible.
2.setuptool
	Download from https://pypi.python.org/pypi/setuptools/#downloads this is a tool to Easily download, build, install, upgrade, and uninstall Python packages
	To install it,run ez_setup.py
3.PyQuery
